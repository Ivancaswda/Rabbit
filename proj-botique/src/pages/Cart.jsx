...
const Cart = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        console.log(typeof wayToDeliver )
        if (!wayToDeliver) {
            toast.warn('Выберите способ доставки!');
            return;
        }
        try {
            let orderItems = []
    ...
    const handleDeliveryMethodClick = (method) => {
        setWayToDeliver(method);  // Обновляем состояние с выбранным способом доставки
    };
    ...
    return (
        ...
        <form onSubmit={onSubmitHandler} className='border-t pt-14 '>
            ...
            {cartData.length > 0 ? (
...

                    {
                        cartData.map((item, index) => {
                            ...
                            return (
                                <div
                                    style={{width: '85%'}}
                                    className='py-4 mb-6 border-t border-b bg-blue-50 p-4 rounded-2xl  text-gray-700 grid  items-center gap-4'
                                key={index}>
                ...
                <div className='flex justify-end bg-blue-50 p-6 rounded-2xl '>
                    <div className='w-full sm:w-[300px]'>
                        <CartTotal/>
                        <div className='w-full text-center flex items-center justify-center mt-4'>


                                <button  className='bg-blue-700 text-white text-lg px-16 py-2 rounded-lg'>Перейти к
                                    оплате
                                </button>
                        ...
                        <div className=' p-4 ' style={{width: '70%'}}>
                            ...
                            { token ?
                                (<div className='bg-blue-50 p-4  ' style={{width: '85%'}}>
                                    ...
                                    <div id='deli' className='flex gap-2 background'>
                                        <div
                                            onClick={() => {
                                                handleDeliveryMethodClick('courier')
                                                localStorage.setItem('wayToDelivery', method)
                                                console.log(wayToDeliver)
                                            }}
                                            className={`cursor-pointer ${wayToDeliver === 'courier' ? 'font-bold' : ''}`}
                                        >
                                            Курьер
                                        </div>
                                        <div
                                            onClick={() => {
                                                handleDeliveryMethodClick('quant-express')
                                                localStorage.setItem('wayToDelivery', method)
                                                console.log(wayToDeliver)
                                            }}
                                            className={`cursor-pointer ${wayToDeliver === 'quant-express' ? 'font-bold' : ''}`}
                                        >
                                            Quant-Express
                                        </div>
                                        <div
                                            onClick={() => {
                                                handleDeliveryMethodClick('pickup')
                                                localStorage.setItem('wayToDelivery', method)
                                                console.log(wayToDeliver)
                                            }}
                                            className={`cursor-pointer ${wayToDeliver === 'pickup' ? 'font-bold' : ''}`}
                                        >
                                    ...
                                    <div className='flex items-center  mb-8'>
                                        <div className='flex items-center gap-2'>
                                            <h1 className='text-lg font-semibold'>Что бы выбрать способ доставки у вас
                                    ...
                                    <div
                                        ...
                                        <div style={{display: "flex", alignItems: "center", gap: "10px"}}>
                                            ...
                                            {!isEmailEditing ? (
                                                ...
                                                >
                  {formData.email ? formData.email : 'Введите ваш email!'}
            </span>
                                            ) : (
                                    ...
                                    <div
                                        ...
                                        <div style={{display: "flex", alignItems: "center", gap: "10px"}}>
                                            ...
                                            {!isAdressEditing ? (
                                                ...
                                                >
                  {!formData.phone ? 'Введите ваш номер телефона!' : formData.phone}
            </span>
                                            ) : (
                                    ...
                                    <div
                                        ...
                                        <div style={{display: "flex", alignItems: "center", gap: "10px"}}>
                                            ...
                                            {!isNameEditing ? (
                                                ...
                                                >
                  {!formData.name ? 'Введите ваше имя' : formData.name}
            </span>
                                            ) : (
                                    ...
                                    <div
                                        ...
                                        <div style={{display: "flex", alignItems: "center", gap: "10px"}}>
                                            ...
                                            {!isSurnameEditing ? (
                                                ...
                                                >
                  {formData.surname ? formData.surname : 'Введите вашу фамилию!'}
            </span>
                                            ) : (
                                    ...
                                    <div
                                        ...
                                        <div style={{display: "flex", alignItems: "center", gap: "10px"}}>
                                            ...
                                            {!isStreetEditing ? (
                                                ...
                                                >
                  {formData.street ? formData.street : 'Введите вашу улицу!'}
            </span>
                                            ) : (
                                    ...
                                    <div
                                        ...
                                        <div style={{display: "flex", alignItems: "center", gap: "10px"}}>
                                            ...
                                            {!isHomeEditing ? (
                                                ...
                                                >
                  {formData.home ? formData.home : 'Введите номер вашего дома!'}
            </span>
                                            ) : (
                                    ...
                                    <div
                                        ...
                                        <div style={{display: "flex", alignItems: "center", gap: "10px"}}>
                                            ...
                                            {!isFlatEditing ? (
                                                ...
                                                >
                  {formData.flat ? formData.flat : 'Введите номер вашей квартиры!'}
            </span>
                                            ) : (
